        ...
        setTimeout(() => {
            ...
            setTimeout(() => {
                ...
                setTimeout(() => {
                    ...
                    ipod.style.transform = 'scale(0)'; // Adjust scale for iPod container
                    ipodScreen.style.transform = 'scale(0)'; // Adjust scale for iPod screen
...
1
    ...
    document.getElementById('sub-button').addEventListener('click', function() {
        ...
        ipod.style.transform = 'scale(0)'; // Start with initial size
        ipodScreen.style.transform = 'scale(0)'; // Start with initial size
